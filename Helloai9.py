...
cv2.putText(image_rgb, 'Center1,', (center1_x - 40, center1_y + 40), font, 0.6, (0, 0, 255), 2, cv2.LINE_AA)
...
plt.title('Anottated Image with Regions, Centers, and Bi-Directional Height Arrow')
plt.axis('off')
plt.show()